...
#     f"G:\My Drive\DataVIS_\VietNam\Data Lake\Raw_VIS/2023-04-04/List_company.csv"
# )
...
TOTAL = len(SYMBOL)
print(SYMBOL)
# print(TOTAL, f'{FU.joinPath(FU.PATH_MAIN_CURRENT,"List_company")}.csv',List_Symbol["Mã CK▲"],6666666666666666666666666666666)

# List_Symbol = pd.read_excel(f'G:\My Drive\DataVIS_\VietNam\Data Lake\Raw_VIS/2022-11-01\Compare/1_Financial_Quarter.xlsx',sheet_name="Trang tính1")
